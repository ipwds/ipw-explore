...
export default function ClareBenFactFinder() {
  ...
  const [form, setForm] = useState<any>({
    ...
    // NEW: Captures the potential dilemma of receiving a favour from family
    familySupport: {
      receivingSupport: 'Undecided', // Yes | No | Undecided
      supportTypes: '', // e.g. gifted equity, interest‑free loan, rent discount, guarantor
      termsOrExpectations: '', // any conditions, repayment expectations, or strings attached
      independenceConcerns: '', // concerns about influence, conflicts, or relationship risk
    },
    other: {
      returnTimeline: '',
      concerns: [] as string[],
  ...
  const concernsList = [
    ...
    'Accepting a favour from family (and how to structure it)', // NEW
  ];
